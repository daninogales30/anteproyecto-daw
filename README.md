...
- A día 8 de mayo, he mejorado y he puesto vistas para que se puedan editar y borrar los entrenamientos y las rutinas. Las dietas también pero no me gusta del todo como ha quedado, lo voy a dejar así y ya voy viendo que cambios puedo hacerle. He mejorado el diseño un poco sobre todo en el del ranking de usuarios más activos, pero me gustaría añadirle css ya que el diseño solo con bootstrapt no me llega a gustar del todo. También le he añadido la descarga del archivo instrucciones.pdf para que el usuario pueda guiarse a través de un manual. Aparte, quiero añadir un video explicativo del funcionamiento de la app tanto como para la entrega del proyecto como para el funcionamiento de la web, para que los usuarios puedan tener un video explicativo de como usar la página web, por si prefieren verlo visualmente antes que leerse el pdf.
