...
urlpatterns = [
    ...
    path("list_semanaldiets_precharged/", views.TodasDietasPrecargadasListView.as_view(), name="list_semanaldiets_precharged"),
    path("list_semanaldiets_precharged/<int:pk>/details/", views.DietasPrecargadasDetailView.as_view(), name="details_semanaldiet_precharged"),
